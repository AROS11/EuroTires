<template>
    ...
    <section class="order-section">
        ...
        <div class="heading">
            <span>book a "Tire Session"</span>
            <h3>Live your moment</h3>
        </div>
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>10000, Prishtina, Republic of Kosovo</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1330.5293455067245!2d21.168615115434228!3d42.66480987922511!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549e3e38b3e8ed%3A0x9b20d1a1604eea8f!2sPristina%2C+Kosovo!5e0!3m2!1sen!2s!4v1637511438358!5m2!1sen!2s"
                        loading="lazy"></iframe>
                </div>
            </div>
